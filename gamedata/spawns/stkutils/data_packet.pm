...
sub _unpack_skeleton {
	...
	@{$container->{bones_mask_ex}} = $self->unpack('C8', 8);
...
sub _pack_skeleton {
	my ($self, $container, $p) = @_;	
	$self->pack('C8C8vf3f3v', @{$container->{bones_mask}}, @{$container->{bones_mask_ex}}, $container->{root_bone}, @{$container->{bbox_min}}, @{$container->{bbox_max}}, $#{$container->{bones}} + 1);
